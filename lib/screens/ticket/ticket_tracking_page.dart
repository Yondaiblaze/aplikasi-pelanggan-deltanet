  ...
  return IntrinsicHeight(
    child: Row(
      ...
      children: [
        SizedBox(
          width: 80,
          child: Text(time, style: TextStyle(fontSize: 12, color: isActive ? Colors.teal : Colors.grey, height: 1.5)),
        ),
        SizedBox(
          width: 12,
          child: Column(
            children: [
              if (!isFirst) Container(width: 2, height: 6, color: Colors.grey[300]),
              Container(
                width: 12,
                height: 12,
                decoration: BoxDecoration(
